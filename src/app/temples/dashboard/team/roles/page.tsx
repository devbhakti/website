...
import { fetchRoles, createRole, updateRole, deleteRole, fetchPermissions } from "@/api/templeAdminController";
...
export default function TempleRolesPage() {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            if (permRes.success) {
                ...
                // Expand modules that have at least one permission
        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-muted-foreground text-sm mt-1">
                        Define roles and assign specific permissions for your temple staff
                    </p>
                </div>
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                {Object.entries(permsByModule).map(([module, labels]) => (
                                                    <div key={module} className="space-y-2">
                                                        <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest border-b border-border/50 pb-1 capitalize">{module} Module</p>
            ...
            {deleteConfirm && (
                <div className="fixed inset-0 z-[110] bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
                    <div className="bg-card border border-border rounded-2xl p-6 shadow-2xl w-full max-w-sm text-center animate-in fade-in zoom-in duration-200">
