...
export default function TempleStaffMembersPage() {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const res = editingStaff
                ? await updateStaffMember(editingStaff.id, body)
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-muted-foreground text-sm mt-1">
                        Monitor and manage your temple staff accounts and digital access
                    </p>
                </div>
            ...
            {loading ? (
                ...
                <div className="text-center py-20 bg-card border border-dashed border-border rounded-2xl">
                    ...
                    <p className="text-sm text-muted-foreground max-w-xs mx-auto mt-1">
                        Try adjusting your search or add your first staff member to your digital temple office.
                    </p>
                </div>
            ) : (
                                    ...
                                    <div className="space-y-1.5">
                                        ...
                                        <div className="relative">
                                            ...
                                            <input value={form.email} onChange={(e) => setForm({ ...form, email: e.target.value })}
                                                placeholder="staff@temple.com" type="email"
                                                className="w-full pl-10 pr-4 py-2.5 bg-background border border-border rounded-xl text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all font-medium" />
                                        </div>
                                    </div>
                                </div>
                ...
                <div className="fixed inset-0 z-[110] bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
                    <div className="bg-card border border-border rounded-2xl p-7 shadow-2xl w-full max-w-sm text-center animate-in fade-in zoom-in duration-200">
                        ...
                        <p className="text-sm text-muted-foreground mb-7 font-medium leading-relaxed">
                            Are you sure you want to remove <span className="text-foreground font-black border-b-2 border-destructive/20">{staffList.find(s => s.id === deleteConfirm)?.name}</span> from the temple system? All active sessions will be terminated.
                        </p>
